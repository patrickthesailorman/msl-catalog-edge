...
public class FacetConstants {
  ...
  public String[] GENRES =
      {"Classical", "Blues", "Dubstep", "Jazz", "Electronica", "Latin", "Soul", "Funk", "Cajun",
          "Celtic", "Folk", "Big Band", "Alternative", "Reggae", "Bluegrass", "Punk", "Rap",
          "Rock", "Hip Hop", "Gospel", "Heavy Metal", "Country", "Salsa", "Opera", "Pop"};
