...
public class StubSongService implements SongService {
  ...
  public StubSongService() {
    ...
    songMockData1
        .setImageLink("https://upload.wikimedia.org/wikipedia/en/6/6d/SteveVaiAlienLoveSecrets.jpg");
    ...
    songMockData5
        .setImageLink("https://upload.wikimedia.org/wikipedia/en/a/ad/UncleJamWantsYou.jpg");
